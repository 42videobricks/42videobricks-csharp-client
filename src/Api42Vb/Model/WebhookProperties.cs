...
namespace Api42Vb.Model
{
    ...
    public partial class WebhookProperties : IValidatableObject
    {
        ...
        public WebhookProperties(string url = default(string), string token = default(string), List<EventTypeEnum> eventType = default(List<EventTypeEnum>))
        {
            ...
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for WebhookProperties and cannot be null");
            }
        ...
        public List<WebhookProperties.EventTypeEnum> EventType { get; set; }
