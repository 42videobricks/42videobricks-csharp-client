...
namespace Api42Vb.Model
{
    ...
    public partial class TagList : IEquatable<TagList>, IValidatableObject
    {
        ...
        public TagList(int offset = default(int), int limit = default(int), int total = default(int), List<string> data = default(List<string>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Total = total;
        ...
        /// </summary>
        /// <param name="input">Instance of TagList to be compared</param>
        /// <returns>Boolean</returns>
