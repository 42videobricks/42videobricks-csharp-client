...
namespace Api42Vb.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VideoMultipartUploadInitResponse_parts_inner")]
    public partial class VideoMultipartUploadInitResponsePartsInner : IEquatable<VideoMultipartUploadInitResponsePartsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoMultipartUploadInitResponsePartsInner" /> class.
        /// </summary>
        /// <param name="signedUrl">part signed url.</param>
        /// <param name="partNumber">part number.</param>
        public VideoMultipartUploadInitResponsePartsInner(string signedUrl = default(string), int partNumber = default(int))
        {
        ...
        {
            return this.Equals(input as VideoMultipartUploadInitResponsePartsInner);
        }

        /// <summary>
        /// Returns true if VideoMultipartUploadInitResponsePartsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of VideoMultipartUploadInitResponsePartsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoMultipartUploadInitResponsePartsInner input)
        {
            if (input == null)
            {
                return false;
